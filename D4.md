...
2.11 As a student buyer, I want to be able to search and filter for key items in searching for.
...
2.12 As a student seller, I want to be able to easily list items with photos and prices to quickly sell said items.
