...
2.8 As a student buyer, I want to be able to message the seller through the app to arrange safe pick up details
...
2.9 As a developer, I want to be able to generate reports such as sales or user activity to better performance
