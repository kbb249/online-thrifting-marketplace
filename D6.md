...
### 2.1: ***Zazel Turner***
#### GitHub Pull Requests Link: https://github.com/kbb249/online-thrifting-marketplace/pulls?q=is%3Apr+author%3Azpt4+ <br>
...
**Automated Testing:** https://github.com/kbb249/online-thrifting-marketplace/blob/main/cs386/Automated%20Testing/testAddItem
...
**Requirement Description:** As a student user, I want to have a secure login page so that I can access my information and the website features. <br>
...
**Automated Testing:** https://github.com/kbb249/online-thrifting-marketplace/blob/main/cs386/Automated%20Testing/testLogin.js
...
**Requirement Description:** As a student user, I want to have a secure sign up page that allows me to create an account so that I can access the websites' features. <br>
...
**Automated Testing:** https://github.com/kbb249/online-thrifting-marketplace/blob/main/cs386/Automated%20Testing/edit-item.test.js
...
**Requirement Description:** As a developer I want to generate reports using the users activity so we can see users analytics. <br>
...
**Automated Testing:** https://github.com/kbb249/online-thrifting-marketplace/blob/main/cs386/Automated%20Testing/testDelete.php
...
**Requirement Description:** As a student user, I want to be able to see all of my listed items so that I can view and access all of my listings in one place. <br>
...
#### Pull Request Screenshot: 
<img width="1254" height="648" alt="Image" src="https://github.com/user-attachments/assets/5151051b-5ef4-4907-9678-5685bd44045d" />

<br>
<br>

**Requirement Description:** As a student buyer, I want to be able to message the seller through the app to arrange safe pick up details. <br>
...
**Automated Testing:** https://github.com/kbb249/online-thrifting-marketplace/blob/main/cs386/Automated%20Testing/testMessaging.js
...
<img width="950" height="479" alt="Screenshot 2025-11-23 at 2 08 05 PM" src="https://github.com/user-attachments/assets/973cf221-9473-4099-82d6-0a045129c4c9" />
...
### 2.5: ***Kaylee Cromwell*** <br>
#### GitHub Pull Requests Link: <br>
https://github.com/kbb249/online-thrifting-marketplace/pulls/kayleeCromwell
#### Pull Request Screenshot: <br>
<img width="499" height="195" alt="Screenshot 2025-11-21 at 5 01 01 PM" src="https://github.com/user-attachments/assets/1fc40d0f-d596-4a7f-9349-e19df28cf7ad" /> <br>
<img width="650" height="574" alt="Screenshot 2025-11-21 at 5 00 55 PM" src="https://github.com/user-attachments/assets/0f412f16-0a21-43bf-ba9d-8f81b3a710bc" /> <br>
...
**Author:** Kaylee Cromwell<br>
**Reviewer:** Henry Hoang<br>
**Automated Testing:** https://github.com/kbb249/online-thrifting-marketplace/blob/main/cs386/Automated%20Testing/3.3Testspec.cy.js <br>
**Visual Evidence:**<br>
...
### 2.6: ***Kendahl*** <br>
#### GitHub Pull Requests Link: https://github.com/kbb249/online-thrifting-marketplace/pull/94 <br>
#### Pull Request Screenshot:
...
**Visual Evidence:** <br> <img width="1176" height="597" alt="Screenshot 2025-11-17 at 10 29 01 PM" src="https://github.com/user-attachments/assets/a40be5cd-eba3-4d12-8f0b-1c3fccdabacc" />  <br>
...
Github folder link: https://github.com/kbb249/online-thrifting-marketplace/tree/main/cs386/Automated%20Testing <br>
Test file: https://github.com/kbb249/online-thrifting-marketplace/blob/main/cs386/Automated%20Testing/integration_test.py <br>
...
<ul>
  ...
  Functions that manage cart state — saving changes, adjusting quantities, merging items — appear in multiple files, including both catalog and cart scripts. Because they aren’t centralized in a single module, the same logic is repeated and maintained in parallel. This duplication makes the system brittle. If one copy is updated (e.g., to change how items are stored or how quantities are calculated) but the other copy is not, cart behavior becomes inconsistent depending on which page the user was on. Over time, the duplicated logic is likely to diverge, turning small changes into system-wide bugs.</li>
      ...
      <li>Code Example - Fixing Heavy innerHTML: <br>
      <img width="662" height="342" alt="Screenshot 2025-11-21 at 3 03 25 PM" src="https://github.com/user-attachments/assets/4c505282-5da4-479a-93d2-6c20a9e7567b" /></li>
      <li>Code Example - Duplicated Cart Logic: <br>
      <img width="559" height="641" alt="Screenshot 2025-11-21 at 3 05 10 PM" src="https://github.com/user-attachments/assets/3622526d-6c20-4186-9817-91b0b54774a6" /></li>
    </ul>
  </li>
</ul>
<br>
...
- I am accepting some of the changes to the security to ensure our users are protected and our website avoids issues like SQL injection. <br>
...
**Explanation:** The code is functional. <br>
...
**Challenges Overcome:**
One of the main challenges we encountered was maintaining consistent communication and managing our time effectively. Towards the end of the project, we realized that stronger planning and more frequent check ins could have helped us develop additional features or imporve on what we have now. Also communication issues became more noticeable, which slowed progress. 

**Future Improvements:** 
Moving forward, we hope that we can make this project better with an enhanced visual appeal in terms of how users interact with it and create a user interface that is more interactive. In addition to making the project better from a user interaction perspective, we plan to improve on our team's ability to manage time effectively as well as to communicate more clearly and frequently. We believe if we improve these two aspects of working together we can develop smoother running future projects.