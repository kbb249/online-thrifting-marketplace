...
### 2.6: ***Kendahl Begay***
#### GitHub Pull Requests Link: <br>
https://github.com/kbb249/online-thrifting-marketplace/issues/85
#### Pull Request Screenshot: <br><img width="492" height="264" alt="Screenshot 2025-11-23 at 9 20 40 PM" src="https://github.com/user-attachments/assets/f5e3bca0-11cd-40fc-b1d1-be1e357e0417" />
 <br>
**Requirement Description:** <br>
As a user, I want to access a settings page to view and update my account details so that I can keep my profile. <br>
**Issue Link:** <br>
https://github.com/kbb249/online-thrifting-marketplace/issues/85 <br>
**Pull Request Link(s):** <br> 
...
**Author:** <br> Kendahl Begay <b>
**Reviewer:** <b> Alexa Aguilar <b>
**Automated Testing:** <br>
**Visual Evidence:**
<img width="1176" height="597" alt="Screenshot 2025-11-17 at 10 29 01 PM" src="https://github.com/user-attachments/assets/52a03b99-e98a-483e-ba41-e87bb213fe87" /> 
...
#### Pull Request Screenshot: <br><img width="492" height="264" alt="Screenshot 2025-11-23 at 9 20 40 PM" src="https://github.com/user-attachments/assets/f5e3bca0-11cd-40fc-b1d1-be1e357e0417" />
 <br>
**Requirement Description:** <br>
As a site visitor, I want to add items from the catalog to a shopping cart, and manage item quantities so that I can review my complete order and finalize purchase details. <br>
**Issue Link:** <br>
https://github.com/kbb249/online-thrifting-marketplace/issues/85 <br>
**Pull Request Link(s):** <br> 
https://github.com/kbb249/online-thrifting-marketplace/issues/122 <br>
**Author:** <br> Kendahl Begay <b>
**Reviewer:** <b> Alexa Aguilar <b>
**Automated Testing:** <br>
**Visual Evidence:** <br>
<img width="1177" height="513" alt="Screenshot 2025-11-19 at 10 17 18 AM" src="https://github.com/user-attachments/assets/31106c32-0ccd-4131-9252-66d571f2c49c" />
<br>
...
1. **Tool:** ChatGPT <br>
2. **Prompt:** How can I make this code better? <br>
3. **Link:** https://chatgpt.com/c/69214839-ee14-8327-aab7-5033e48e6f0f <br>

**Detailed Analysis and Response:** <br>
Right now your list-group sits in a plain <div>. Using <nav> makes it more accessible and semantic. You have several my-5 and mb-5 that can be simplified using groups of spacing classes. You're missing the closing </footer> content. Either remove it or add content. You already do this for some fields, but you should add it to all inputs—especially switches. Updating settings should happen inside a <form> — improves structure and eases JS/plugin integration. You already do this; just make sure each has its own internal structure, which you’ve mostly done right. Add aria- labels for navigation. Helps screen readers. Add Bootstrap spacing utilities for “setting-item”.You manually spaced them using d-flex. You manually spaced them using d-flex. Or use your own CSS. If you want a nicer experience, add JavaScript so the active tab changes as you scroll or click. <br>
**Assigned Reviewer:** Kendahl Begay <br>
**Severity Assessment:** Medium <br>
**Decision:** Rejected <br>
**Explanation:** The original code is perfectly adequate. <br>
